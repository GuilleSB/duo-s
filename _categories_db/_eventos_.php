<head>
    ...
    <meta name="description" content="Encuentra eventos en duo-s.com.">
...
<div class="col-md-12 categories_body">
    ...
    <div class="col-sm-12 col-md-9 col-lg-9 text-center">
        <div class="text-center"><br><br>
            ...
            <h1>Entretenimiento</h1><br>
        </div>
        <button class="btn btn-default filter-button active" data-filter="all">Todo</button>
        <button class="btn btn-default filter-button" data-filter="1">Discomóvil</button>
        <button class="btn btn-default filter-button" data-filter="2">Fiestas</button>
        <button class="btn btn-default filter-button" data-filter="3">Grupo musical</button>
        <button class="btn btn-default filter-button" data-filter="4">Karaoke</button>
        <button class="btn btn-default filter-button" data-filter="5">Salón de eventos</button>
        <button class="btn btn-default filter-button" data-filter="6">Televisión</button>
    </div><br/>
    
    
    <div class="main_body_page col-xxs-12 col-xs-12 col-sm-12 col-md-9 col-lg-9"> 
        <?php include ('./_eventos.php');?>
    </div>
