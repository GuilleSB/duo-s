<head>
    ...
    <meta name="description" content="Encuentra accesorios y deportes recreativos en duo-s.com.">
    <title>Deportes | duo-s.com</title>
</head>
...
<div class="col-md-12 categories_body">
    ...
    <div class="col-sm-12 col-md-9 col-lg-9 text-center">
        ...
        <button class="btn btn-default filter-button" data-filter="1">Alquiler de canchas</button>
        <button class="btn btn-default filter-button" data-filter="2">Equipos deportivos</button>
        <button class="btn btn-default filter-button" data-filter="3">Implementos deportivos</button>       
        <button class="btn btn-default filter-button" data-filter="4">Tienda deportiva</button>
    </div><br/>
    
    
    <div class="main_body_page col-xxs-12 col-xs-12 col-sm-12 col-md-9 col-lg-9"> 
        <?php include ('./_deportes.php');?>
    </div>
