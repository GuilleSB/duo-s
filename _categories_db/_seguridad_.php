<head>
    ...
    <meta name="description" content="Encuentra empresas de seguridad en duo-s.com.">
    <title>Empresas de seguridad | duo-s.com</title>
</head>
...
<div class="col-md-12 categories_body">
    ...
    <div class="col-sm-12 col-md-9 col-lg-9 text-center">
        ...
        <button class="btn btn-default filter-button" data-filter="1">Empresas de seguridad</button>
    </div><br/>
    
    <div class="main_body_page col-xxs-12 col-xs-12 col-sm-12 col-md-9 col-lg-9"> 
        <?php include ('./_seguridad.php');?>
    </div>
