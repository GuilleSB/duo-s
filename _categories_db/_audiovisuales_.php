<head>
    ...
    <meta name="description" content="Encuentra audiovisuales en duo-s.com.">
    <title>Audiovisuales | duo-s.com</title>
</head>

<?php
    $head_name="Audiovisuales";
    include ('../_menu.php');
?>
