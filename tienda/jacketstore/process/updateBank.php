...
$bancoSinpe=consultasSQL::clean_string($_POST['bancoSinpe']);

if(consultasSQL::UpdateSQL("cuentabanco", "NumeroCuenta='$bancoCuenta', NombreBanco='$bancoNombre', NombreBeneficiario='$bancoBeneficiario', TipoCuenta='$bancoTipo', SinpeMovil='$bancoSinpe'", "id='$id'")){
  echo '<script>
  swal({
