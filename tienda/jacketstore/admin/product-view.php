<p class="lead text-center">
  Para agregar un producto, complete el formulario "Datos Básicos". <br>
  <b>IMPORTANTE:</b> Para ingresar una "categoría y proveedor", estos deben estar ya agregados, si no los ha agregado puede hacerlo en las pestañas <b>"Proveedores"</b> y <b>"Categorias"</b>. <br> Para visualizar los productos, solamente selecciona la pestaña <b>"Productos en tienda"</b>.
</p>
