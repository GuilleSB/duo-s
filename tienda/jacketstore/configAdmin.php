    ...
    <section id="prove-product-cat-config">
        <div class="container">
          <div class="page-header">
            <h1>Panel de administración <small class="tittles-pages-logo"><?php echo $store;?></small></h1>
          </div>
          <!--====  Nav Tabs  ====-->
          ...
          <?php
            ...
            if(isset($content)){
              ...
              echo '<h2 class="text-center">Para empezar, por favor selecciona la pestaña "mi cuenta" y escribe un nombre de usuario y elige una contraseña segura</h2>';
            }
          ?>
        </div>
    </section>
