...
<?php include './idsources.php'; ?>
            ...
            <div class="col-xs-8">
              <div class="contenedor-tabla pull-right">
                <div class="contenedor-tr">
                  <a href="https://www.duo-s.com/tienda/jacketstore" class="table-cell-td">Inicio</a>
    ...
    <style>
      .movil_logo{display:block;margin:auto;}
    </style>
    
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <img class="movil_logo" src="./assets/img/logo.png">
