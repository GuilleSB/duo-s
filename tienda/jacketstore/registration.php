    ...
    <section id="form-registration">
        <div class="container">
            ...
            <p class="lead text-center">
              Para poder adquirir nuestros productos en línea solamente tienes que llenar este sencillo formulario. <br> Estaremos muy felices de que seas parte de nosotros.
            </p>
            <div class="row">
