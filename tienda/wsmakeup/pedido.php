    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>PEDIDOS <small class="tittles-pages-logo"><?php echo $store;?></small></h1>
            </div>
            <br><br><br>
            <div class="row">
      ...
      <div class="modal-dialog" role="document">
        <form class="modal-content FormCatElec" action="process/confirmcompra.php" method="POST" role="form" data-form="save">
          ...
          <div class="modal-body">
            ...
            ?>
            <p>Por favor haga el depósito en la siguiente cuenta de banco e ingrese el número de depósito que se le proporcionó, si gusta también puede realizar una transacción mediante Sinpe Móvil.</p><br>
            <p>
              ...
              <strong>Sinpe Móvil:</strong> <?php echo $datBank['SinpeMovil']; ?><br><br>
            </p>
                ...
                <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <p class="help-block"><small>Tipos de archivos admitidos, imágenes .jpg y .png. Maximo 5 MB</small></p>
                    </div>
                <?php else: ?>
                    <div class="form-group">
