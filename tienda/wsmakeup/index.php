...
<html lang="es"> 
<head>
    <meta name="keywords" content="venta de cosméticos, cuidado de la piel, maquillaje profesional, lifting de pestañas, laminado de cejas, perfilado de cejas, talleres de automaquillaje">
    <meta name="description" content="WS MakeUp es su tienda en línea de venta de cosméticos y cuidado personal, contamos también con talleres de automaquillaje">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="WS MakeUp" />
    <meta property="og:description" content="WS MakeUp es su tienda en línea de venta de cosméticos y cuidado personal, contamos también con talleres de automaquillaje" />
    <meta property="og:image" content="https://www.duo-s.com/tienda/wsmakeup/assets/img/index_image.png" />      
    <meta property="og:url" content="https://www.duo-s.com/tienda/wsmakeup" />
    <title>Venta de cosméticos | WS make-up</title>
...
<body id="container-page-index">
    ...
    <section id="new-prod-index">    
         <div class="container">
            <h1 class="text-center">Bienvenidos a WS MakeUP, su tienda de cosméticos</h1>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo"><?php echo $store; ?></span> en un sencillo formulario para poder completar tus pedidos</p>
                        <p><a href="registration.php" class="btn btn-info btn-raised btn-block">Registrarse</a></p>   
                   </article>
                </div>

                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/index_image.png" alt="imagen de index" class="img-responsive" style="width: 70%; display: block; margin: 0 auto;">
                </div>
            </div>
        </div>
    </section>
