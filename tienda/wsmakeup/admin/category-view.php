<p class="lead text-center">
    Para agregar una categoría, complete el formulario "Agregar nueva categoría". <br> Para visualizar las categorías, solamente selecciona la pestaña <b>"Categoría de productos".</b>
</p>
	...
	<div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin"> 
                <h3 class="text-primary text-center">Agregar nueva categoría</h3>
