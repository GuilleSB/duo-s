	...
	<div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                <h3 class="text-primary text-center">Actualizar cuenta</h3>
                <?php
                ...
                <form action="./process/updateAdmin.php" method="POST" role="form" class="FormCatElec" data-form="update">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                            	<p class="text-primary text-center" style="padding-top: 20px;">Si desea actualizar la contraseña, debe de ingresar una nueva contraseña y volver a ingresarla</p>
                            </div>
