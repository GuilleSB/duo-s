                  ...
                  <form action="./process/updateBank.php" method="POST" role="form" class="form-content FormCatElec" data-form="update">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <div class="form-group label-floating">
                                    <label class="control-label">Sinpe móvil</label>
                                    <input class="form-control" type="text" name="bancoSinpe" value="<?php echo $bankD['SinpeMovil']; ?>" maxlength="50" required="">
                                </div>
                            </div>
                        </div>
                    </div>
                    <p class="text-center"><button type="submit" class="btn btn-primary btn-raised">Actualizar cuenta de banco</button></p>
                  </form>
                  </div>
            <?php
                }else{
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <div class="form-group label-floating">
                                <label class="control-label">Sinpe Móvil</label>
                                <input class="form-control" type="text" name="bancoSinpe" maxlength="50" required="">
                            </div>
                        </div>
                    </div>
                </div>
