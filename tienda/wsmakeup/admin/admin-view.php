...
Para agregar un administrador, complete el formulario "Agregar un nuevo administrador". <br>
Para visualizar los administradores, solamente selecciona la pestaña <b>"Administradores del sistema ".</b> <br>
Actualice su cuenta desde la pestaña <b>"Mi cuenta".</b>
</p>
	...
	<div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                <h3 class="text-primary text-center">Agregar un nuevo administrador</h3>
