...
<div class="recommend_button">
    <button data-toggle="modal" data-target="#recommend" class="btn-round center-block">Recomendar duo-s.com a una empresa                        
    </button>
</div>                  

 <!-- line modal -->
 <div class="modal fade" id="recommend" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true" style="display: none;">
        	    ...
        	    <div class="modal-content">
        		    ...
        		    <div class="modal-body">
                        ...
                        <form class="recommend_form" action="./_whatsapp.php" method="POST">
                            ...
                            <input class="recommend_input" type="text" name="friendname" placeholder=" Encargado(a) de la empresa que desea recomendar" autocomplete="off" required>
